...
CREATE TABLE 'cars' (
    ...
    'created_date' DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '建立時間',
    'last_modified_date' DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新時間'
